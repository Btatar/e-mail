...
public class Steganography {
	...
	boolean encode(BufferedImage input, BufferedImage output, int width, int height, String msg,String URL) {
		...
		try {
			ImageIO.write(output, "png", new File(URL+".png")); //create .PNG file with encoded image data
			return true;
		} catch (IOException e) {
			e.printStackTrace();
			return false;
